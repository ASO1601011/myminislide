package com.example.izumin.myminislide;
...
public class MainActivity extends AppCompatActivity {
    ...
    int[] mImageResources = {R.drawable.hatsune1,R.drawable.hatsune2,
            R.drawable.hatsune3,R.drawable.hatsune4,R.drawable.hatsune5,R.drawable.hatsune6,
            R.drawable.hatsune7,R.drawable.hatsune8,R.drawable.hatsune9};
    int mPosition = 0;
